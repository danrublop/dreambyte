/**
 * SVGLoader — vendored from three@0.160.0/examples/jsm/loaders/SVGLoader.js.
 * Classic-script form: pulls required THREE classes from window.THREE instead
 * of `import 'three'`, so it shares the UMD THREE instance and does not trip
 * the "Multiple instances of Three.js" warning. Exposes window.SVGLoader.
 *
...
;(function () {
  ...
  var T = window.THREE
  if (!T) {
    console.error('[SVGLoader] window.THREE not found — load three.min.js first.')
    return
  }
  var Box2 = T.Box2
