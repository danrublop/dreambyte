var ThreeCSM = (() => {
  ...
  var three_custom_shader_material_es_exports = {};
  __export(three_custom_shader_material_es_exports, {
    default: () => j
  });
  var v = window.THREE;
  var D = (
...
`
  ...
  var j = class extends v.Material {
    constructor({
      baseMaterial: a,
      vertexShader: _,
      fragmentShader: A,
...
` + s.fragmentShader;
  ...
  return __toCommonJS(three_custom_shader_material_es_exports);
})();
