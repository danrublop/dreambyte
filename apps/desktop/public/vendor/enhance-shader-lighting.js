var EnhanceShaderLighting = (() => {
  ...
  // node_modules/enhance-shader-lighting/dist/index.js
  var index_exports = {};
  __export(index_exports, {
    enhanceShaderLighting: () => enhanceShaderLighting
  });
...
`
  ...
  var map_fragment = THREE.ShaderChunk.map_fragment.replace(
  ...
  var lights_pars_begin = THREE.ShaderChunk.lights_pars_begin.replace(
  ...
  var lights_fragment_maps = THREE.ShaderChunk.lights_fragment_maps.replace("USE_LIGHTMAP", "false");
  var lightmap_fragment = THREE.ShaderChunk.lightmap_fragment.replace("USE_LIGHTMAP", "false");
  ...
  function enhanceShaderLighting(shader, {
    aoColor = new THREE.Color(0),
    hemisphereColor = new THREE.Color(16777215),
    irradianceColor = new THREE.Color(16777215),
    radianceColor = new THREE.Color(16777215),
    aoPower = 1,
    aoSmoothing = 0,
    aoMapGamma = 1,
    lightMapGamma = 1,
