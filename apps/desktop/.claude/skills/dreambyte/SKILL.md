...
0. `docs/DESIGN.md` (project root) — **TOKENS FIRST**: read the YAML frontmatter for exact color hex values, type sizes, spacing values, and named layout patterns. These are the values to use — not approximations, not inventions.
